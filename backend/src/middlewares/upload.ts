...
const fileSizeValidator = (req: Request, file: Express.Multer.File, cb: multer.FileFilterCallback) => {
...
export const validateFileSize = (file: Express.Multer.File, fieldName: string): boolean => {
  let maxSize = MAX_IMAGE_SIZE;
