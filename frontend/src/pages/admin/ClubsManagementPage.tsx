            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-start mb-3">
                  <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden border-4 border-white -mt-8 relative">
                    {club.profilePicture ? (
                      <img 
                      ...
                      <span className="text-2xl font-bold text-gray-600">{club.name.charAt(0)}</span>
                    )}
                  </div>
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              ...
              <EditClubForm club={selectedClub} closeModal={() => {
